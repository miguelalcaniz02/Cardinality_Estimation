...
from sampling import generate_zipf_stream
import numpy as np
import string
import random
...
N = 100000 # Tamaño del flujo de datos
n = 10000  # Número de posibles elementos distintos
alpha = 0.6 # Parámetro de Zipf

# Producir el dataset
data = generate_zipf_stream(n, alpha, N)

print("0 %")

cardinality = len(set(data)) #Cardinal real
runs = 30 #Numero de ejecuciones
